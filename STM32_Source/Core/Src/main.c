...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, EN3_Pin|EN2_Pin|DOT_Pin|LED_RED_Pin
  ...
  /*Configure GPIO pins : EN3_Pin EN2_Pin DOT_Pin LED_RED_Pin
                           EN0_Pin EN1_Pin */
  GPIO_InitStruct.Pin = EN3_Pin|EN2_Pin|DOT_Pin|LED_RED_Pin
                          |EN0_Pin|EN1_Pin;
